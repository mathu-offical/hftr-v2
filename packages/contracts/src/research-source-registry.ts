...
export const RESEARCH_SOURCE_REGISTRY: Record<ResearchSourceKindType, ResearchSourceDescriptor> = {
  ...
  gdelt_news: {
    ...
    defaultEnabledWhenReady: true,
    docsUrl: DOCS.gdelt,
    notes: 'GDELT DOC 2.0 ArtList global news; one 429 retry with backoff.',
  },
  ...
  twelve_data: {
    ...
    domain: 'equity_bars',
    authMode: 'research_key',
    keyProvider: 'twelve_data',
    feedClass: RESEARCH_SOURCE_FEED_CLASS.twelve_data,
    implementation: 'shipped',
    liveMode: 'rest_poll',
    defaultEnabledWhenReady: true,
    docsUrl: DOCS.twelveData,
    notes: 'Twelve Data daily series entitlement check; OHLC stays on ValueRef path.',
  },
  marketstack: {
    kind: 'marketstack',
    domain: 'equity_bars',
    authMode: 'research_key',
    keyProvider: 'marketstack',
    feedClass: RESEARCH_SOURCE_FEED_CLASS.marketstack,
    implementation: 'shipped',
    liveMode: 'rest_poll',
    defaultEnabledWhenReady: true,
    docsUrl: DOCS.marketstack,
    notes: 'Marketstack EOD entitlement check; numeric EOD stays on ValueRef path.',
  },
  catalog: {
    kind: 'catalog',
    domain: 'internal',
