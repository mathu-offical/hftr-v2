...
| REQ-MDL-012 | Trading presets (crypto, prediction, HFT, long-term) | agent-docs/product/product-spec.md §3 | **partial** | paper HFT + microstructure lab (D-157); crypto gated on session envelope; live HFT fail-closed | M5 live gate + crypto session | alpaca, kalshi | strategy_outcome | operational |
