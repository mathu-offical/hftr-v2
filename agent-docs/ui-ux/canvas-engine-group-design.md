...
- **Option anchors (D-173 / D-180 / D-191 / D-202 / D-207 / D-208 / D-213 / D-217 / D-218 / D-219 / D-220 / D-222):** unified **decision nodes**
  ...
  to the reserved right column. Column gutters clear decision width. Canvas cards are
  limited to `CANVAS_PRIMARY_DECISION_KINDS`. Lever bands remain inspector-only.
