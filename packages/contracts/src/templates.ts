...
const EXECUTION_DESK_DECISION_SEEDS = (
  ...
  { kind: 'research_subtype', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
  { kind: 'curiosity_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
  { kind: 'admission_mode', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
  { kind: 'cadence_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
  {
    kind: 'branch_role',
    ownerModuleIndex: 0,
  ...
  { kind: 'librarian_subtype', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
  { kind: 'cadence_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
  { kind: 'library_class', ownerModuleIndex: 2, connectionMode: 'emit_decision' },
  { kind: 'feed_class', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
  { kind: 'query_policy', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
  { kind: 'schedule_policy', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
  { kind: 'trend_posture', ownerModuleIndex: 4, connectionMode: 'emit_decision' },
  { kind: 'cadence_band', ownerModuleIndex: 4, connectionMode: 'emit_decision' },
  {
  ...
  { kind: 'branch_role', ownerModuleIndex: tradeIndex, connectionMode: 'route_data' },
  { kind: 'recovery_phase', ownerModuleIndex: tradeIndex, connectionMode: 'route_data' },
  { kind: 'emit_mode', ownerModuleIndex: analyzerIndex, connectionMode: 'route_data' },
];

/**
 * Pure-data research-pack seeds (curator → librarian → library → analyzer).
 * Locks purpose subtype / librarian / library / pipeline (D-222 / D-224).
 */
const RESEARCH_PACK_DECISION_SEEDS = (opts: {
  researchSubtype: string;
  librarianSubtype: string;
  libraryClass: string;
  pipelineRefs?: readonly string[];
  emitMode?: string;
}): EngineTemplateDecisionSeed[] => {
  const pipelineRefs = opts.pipelineRefs ?? ['discover', 'verify_sanity'];
  return [
    {
      kind: 'research_subtype',
      ownerModuleIndex: 0,
      optionRefs: [opts.researchSubtype],
      defaultSelectedRef: opts.researchSubtype,
      connectionMode: 'emit_decision',
    },
    { kind: 'curiosity_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
    { kind: 'admission_mode', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
    { kind: 'cadence_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
    ...
    },
    {
      ...
      ownerModuleIndex: 1,
      optionRefs: [opts.librarianSubtype],
      defaultSelectedRef: opts.librarianSubtype,
      connectionMode: 'emit_decision',
    },
    { kind: 'cadence_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
    {
      kind: 'library_class',
      ownerModuleIndex: 2,
      optionRefs: [opts.libraryClass],
      defaultSelectedRef: opts.libraryClass,
      connectionMode: 'emit_decision',
    },
    {
      kind: 'emit_mode',
      ownerModuleIndex: 3,
      ...(opts.emitMode
        ? { optionRefs: [opts.emitMode], defaultSelectedRef: opts.emitMode }
        : {}),
      connectionMode: 'route_data',
    },
  ];
...
/**
 * Dual-curator market/trend research pack seeds (D-224).
 * Locks each curator subtype + purpose librarian/library/pipeline + emit/route modes.
 */
const DUAL_CURATOR_RESEARCH_SEEDS = (opts: {
  curator0: string;
  curator1: string;
  librarianSubtype: string;
  libraryClass: string;
  pipeline0?: readonly string[];
  pipeline1?: readonly string[];
  emitMode?: string;
  librarianIndex?: number;
  libraryIndex?: number;
  feedIndex?: number;
  trendIndex?: number;
  analyzerIndex?: number;
}): EngineTemplateDecisionSeed[] => {
  const librarianIndex = opts.librarianIndex ?? 2;
  const libraryIndex = opts.libraryIndex ?? 3;
  const feedIndex = opts.feedIndex ?? 4;
  const trendIndex = opts.trendIndex ?? 5;
  const analyzerIndex = opts.analyzerIndex ?? 6;
  const pipeline0 = opts.pipeline0 ?? ['discover', 'verify_sanity'];
  const pipeline1 = opts.pipeline1 ?? ['discover', 'verify_sanity'];
  return [
    {
      kind: 'research_subtype',
      ownerModuleIndex: 0,
      optionRefs: [opts.curator0],
      defaultSelectedRef: opts.curator0,
      connectionMode: 'emit_decision',
    },
    { kind: 'curiosity_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
    { kind: 'admission_mode', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
    ...
    },
    {
      kind: 'research_subtype',
      ownerModuleIndex: 1,
      optionRefs: [opts.curator1],
      defaultSelectedRef: opts.curator1,
      connectionMode: 'emit_decision',
    },
    { kind: 'curiosity_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
    { kind: 'admission_mode', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
    { kind: 'cadence_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
    {
      kind: 'branch_role',
      ownerModuleIndex: 1,
      optionRefs: [...pipeline1],
      defaultSelectedRef: 'discover',
      connectionMode: 'route_data',
    },
    {
      kind: 'librarian_subtype',
      ownerModuleIndex: librarianIndex,
      optionRefs: [opts.librarianSubtype],
      defaultSelectedRef: opts.librarianSubtype,
      connectionMode: 'emit_decision',
    },
    { kind: 'cadence_band', ownerModuleIndex: librarianIndex, connectionMode: 'emit_decision' },
    {
      kind: 'library_class',
      ownerModuleIndex: libraryIndex,
      optionRefs: [opts.libraryClass],
      defaultSelectedRef: opts.libraryClass,
      connectionMode: 'emit_decision',
    },
    { kind: 'feed_class', ownerModuleIndex: feedIndex, connectionMode: 'emit_decision' },
    { kind: 'query_policy', ownerModuleIndex: feedIndex, connectionMode: 'emit_decision' },
    { kind: 'schedule_policy', ownerModuleIndex: feedIndex, connectionMode: 'emit_decision' },
    { kind: 'trend_posture', ownerModuleIndex: trendIndex, connectionMode: 'emit_decision' },
    { kind: 'cadence_band', ownerModuleIndex: trendIndex, connectionMode: 'emit_decision' },
    {
      kind: 'emit_mode',
      ownerModuleIndex: analyzerIndex,
      ...(opts.emitMode
        ? { optionRefs: [opts.emitMode], defaultSelectedRef: opts.emitMode }
        : {}),
      connectionMode: 'route_data',
...
const SIM_DESK_DECISION_SEEDS = (
  ...
  return [
    ...
    { kind: 'branch_role', ownerModuleIndex: tradingIndex, connectionMode: 'route_data' },
    { kind: 'recovery_phase', ownerModuleIndex: tradingIndex, connectionMode: 'route_data' },
...
export const ENGINE_TEMPLATES: EngineTemplate[] = [
  ...
  },
  {
    ...
    decisionNodes: [
      ...RESEARCH_PACK_DECISION_SEEDS({
        researchSubtype: 'specialty_desk',
        librarianSubtype: 'librarian_desk_session',
        libraryClass: 'topic_runtime',
      }).filter((s) => s.kind !== 'emit_mode'),
      { kind: 'trend_posture', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      { kind: 'cadence_band', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      { kind: 'emit_mode', ownerModuleIndex: 4, connectionMode: 'route_data' },
    ],
  },
  {
    id: 'engine_crypto',
    ...
    modules: [
      {
        ...
        config: {
          ...
          sourceAllowlist: ['brave', 'marketaux'],
        },
        position: { x: 0, y: 0 },
      },
      {
        type: 'librarian',
        name: 'Web Fabric Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_web_fabric',
          cadenceMinutes: 120,
          relevanceWeights: { topical: 0.45, freshness: 0.35, evidenceFit: 0.2 },
        },
        position: { x: 0, y: 280 },
      },
      {
  ...
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          sourceAllowlist: ['sec_edgar', 'finnhub_news'],
        },
        position: { x: 0, y: 0 },
      },
      {
        type: 'librarian',
        name: 'Filings Hygiene Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_filings_hygiene',
          cadenceMinutes: 360,
          relevanceWeights: { topical: 0.35, freshness: 0.15, evidenceFit: 0.5 },
        },
        position: { x: 0, y: 280 },
      },
      {
    ...
    decisionNodes: RESEARCH_PACK_DECISION_SEEDS({
      ...
      librarianSubtype: 'librarian_filings_hygiene',
      libraryClass: 'topic_runtime',
      pipelineRefs: ['discover', 'extract_fundamentals', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  {
    ...
    decisionNodes: [
      {
        kind: 'librarian_subtype',
        ownerModuleIndex: 0,
        optionRefs: ['librarian_seed_keeper'],
        defaultSelectedRef: 'librarian_seed_keeper',
        connectionMode: 'emit_decision',
      },
      { kind: 'cadence_band', ownerModuleIndex: 0, connectionMode: 'emit_decision' },
      {
        kind: 'research_subtype',
        ownerModuleIndex: 1,
        optionRefs: ['external_web'],
        defaultSelectedRef: 'external_web',
        connectionMode: 'emit_decision',
      },
      { kind: 'curiosity_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
      { kind: 'admission_mode', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
      ...
      },
      {
        kind: 'library_class',
        ownerModuleIndex: 2,
        optionRefs: ['seeded_mechanisms'],
        defaultSelectedRef: 'seeded_mechanisms',
        connectionMode: 'emit_decision',
      },
      {
        kind: 'emit_mode',
        ownerModuleIndex: 3,
        optionRefs: ['to_library'],
        defaultSelectedRef: 'to_library',
        connectionMode: 'route_data',
      },
    ],
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          cadenceMinutes: 180,
          admissionMode: 'auto_admit_validated',
          sourceAllowlist: ['alpaca_news', 'finnhub_news', 'polygon_news'],
        },
        position: { x: 0, y: 0 },
      },
      {
        type: 'librarian',
        name: 'Event Triage Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_event_triage',
          cadenceMinutes: 180,
          relevanceWeights: { topical: 0.3, freshness: 0.4, evidenceFit: 0.3 },
        },
        position: { x: 0, y: 280 },
      },
      {
    ...
    decisionNodes: RESEARCH_PACK_DECISION_SEEDS({
      ...
      librarianSubtype: 'librarian_event_triage',
      libraryClass: 'specialty_evidence',
      pipelineRefs: ['discover', 'window_catalyst', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          curiosity: 'balanced',
          cadenceMinutes: 60,
          sourceAllowlist: ['alpaca_news', 'finnhub_news', 'marketaux'],
        },
        position: { x: 0, y: 0 },
      },
      {
        ...
        config: {
          ...
          curiosity: 'balanced',
          cadenceMinutes: 90,
          sourceAllowlist: ['brave', 'alpaca_news'],
        },
        position: { x: 0, y: 280 },
      },
      {
        type: 'librarian',
        name: 'Regime Context Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_regime_context',
          cadenceMinutes: 120,
          relevanceWeights: { topical: 0.3, freshness: 0.4, evidenceFit: 0.3 },
        },
        position: { x: 0, y: 560 },
    ...
    decisionNodes: DUAL_CURATOR_RESEARCH_SEEDS({
      curator0: 'external_market_news',
      curator1: 'specialty_desk',
      librarianSubtype: 'librarian_regime_context',
      libraryClass: 'specialty_evidence',
      pipeline0: ['discover', 'regime_frame', 'verify_sanity'],
      pipeline1: ['discover', 'desk_filter', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          curiosity: 'exploratory',
          cadenceMinutes: 60,
          sourceAllowlist: ['brave', 'finnhub_news'],
        },
        position: { x: 0, y: 0 },
      },
      {
      ...
      {
        type: 'librarian',
        name: 'Crypto Narrative Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_crypto_narrative',
          cadenceMinutes: 90,
          relevanceWeights: { topical: 0.35, freshness: 0.4, evidenceFit: 0.25 },
        },
        position: { x: 0, y: 560 },
      },
      {
    ...
    decisionNodes: DUAL_CURATOR_RESEARCH_SEEDS({
      curator0: 'crypto_onchain_context',
      curator1: 'external_market_news',
      librarianSubtype: 'librarian_crypto_narrative',
      libraryClass: 'specialty_evidence',
      pipeline0: ['discover', 'onchain_context', 'verify_sanity'],
      pipeline1: ['discover', 'regime_frame', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          curiosity: 'exploratory',
          cadenceMinutes: 90,
          sourceAllowlist: ['brave', 'finnhub_news', 'polygon_news'],
        },
        position: { x: 0, y: 0 },
      },
      {
      ...
      {
        type: 'librarian',
        name: 'Prediction Odds Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_prediction_odds',
          cadenceMinutes: 90,
          relevanceWeights: { topical: 0.35, freshness: 0.35, evidenceFit: 0.3 },
        },
        position: { x: 0, y: 560 },
      },
      {
    ...
    decisionNodes: DUAL_CURATOR_RESEARCH_SEEDS({
      curator0: 'prediction_niche',
      curator1: 'event_catalyst',
      librarianSubtype: 'librarian_prediction_odds',
      libraryClass: 'specialty_evidence',
      pipeline0: ['discover', 'niche_scan', 'verify_sanity'],
      pipeline1: ['discover', 'window_catalyst', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          curiosity: 'balanced',
          cadenceMinutes: 45,
          sourceAllowlist: ['brave', 'alpaca_news', 'marketaux'],
        },
        position: { x: 0, y: 0 },
      },
      {
        type: 'librarian',
        name: 'Desk Session Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_desk_session',
          cadenceMinutes: 60,
          relevanceWeights: { topical: 0.4, freshness: 0.4, evidenceFit: 0.2 },
        },
        position: { x: 0, y: 280 },
      },
      {
    ...
    decisionNodes: [
      ...RESEARCH_PACK_DECISION_SEEDS({
        ...
        librarianSubtype: 'librarian_desk_session',
        libraryClass: 'specialty_evidence',
        pipelineRefs: ['discover', 'desk_filter', 'verify_sanity'],
      }).filter((s) => s.kind !== 'emit_mode'),
      { kind: 'feed_class', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      { kind: 'query_policy', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      { kind: 'schedule_policy', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      ...
      { kind: 'cadence_band', ownerModuleIndex: 4, connectionMode: 'emit_decision' },
      {
        kind: 'emit_mode',
        ownerModuleIndex: 5,
        optionRefs: ['to_desk_stream'],
        defaultSelectedRef: 'to_desk_stream',
        connectionMode: 'route_data',
      },
    ],
  },
  {
    ...
    modules: [
      ...
      {
        type: 'librarian',
        name: 'Multi-curator Librarian',
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_web_fabric',
          cadenceMinutes: 180,
          relevanceWeights: { topical: 0.4, freshness: 0.3, evidenceFit: 0.3 },
        },
        position: { x: 0, y: 840 },
      },
      {
    ...
    decisionNodes: [
      ...
      },
      {
        kind: 'research_subtype',
        ownerModuleIndex: 1,
        optionRefs: ['external_filings'],
        defaultSelectedRef: 'external_filings',
        connectionMode: 'emit_decision',
      },
      { kind: 'curiosity_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
      { kind: 'admission_mode', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
      { kind: 'cadence_band', ownerModuleIndex: 1, connectionMode: 'emit_decision' },
      {
        kind: 'branch_role',
        ownerModuleIndex: 1,
        optionRefs: ['discover', 'extract_fundamentals', 'verify_sanity'],
        defaultSelectedRef: 'discover',
        connectionMode: 'route_data',
      },
      {
        kind: 'research_subtype',
        ownerModuleIndex: 2,
        optionRefs: ['external_market_news'],
        defaultSelectedRef: 'external_market_news',
        connectionMode: 'emit_decision',
      },
      { kind: 'curiosity_band', ownerModuleIndex: 2, connectionMode: 'emit_decision' },
      { kind: 'admission_mode', ownerModuleIndex: 2, connectionMode: 'emit_decision' },
      { kind: 'cadence_band', ownerModuleIndex: 2, connectionMode: 'emit_decision' },
      {
        kind: 'branch_role',
        ownerModuleIndex: 2,
        optionRefs: ['discover', 'regime_frame', 'verify_sanity'],
        defaultSelectedRef: 'discover',
        connectionMode: 'route_data',
      },
      {
        kind: 'librarian_subtype',
        ownerModuleIndex: 3,
        optionRefs: ['librarian_web_fabric'],
        defaultSelectedRef: 'librarian_web_fabric',
        connectionMode: 'emit_decision',
      },
      { kind: 'cadence_band', ownerModuleIndex: 3, connectionMode: 'emit_decision' },
      {
        kind: 'library_class',
        ownerModuleIndex: 4,
        optionRefs: ['topic_runtime'],
        defaultSelectedRef: 'topic_runtime',
        connectionMode: 'emit_decision',
      },
      {
        kind: 'library_class',
        ownerModuleIndex: 5,
        optionRefs: ['specialty_evidence'],
        defaultSelectedRef: 'specialty_evidence',
        connectionMode: 'emit_decision',
      },
      {
        kind: 'emit_mode',
  ...
  },
  {
    ...
    modules: [
      {
        ...
        config: {
          ...
          curiosity: 'exploratory',
          cadenceMinutes: 30,
          sourceAllowlist: ['alpaca_bars', 'alpaca_news'],
        },
        position: { x: 0, y: 0 },
      },
      {
      ...
      },
      {
        ...
        config: {
          topicScope: 'pending_operator_scope',
          librarianSubtype: 'librarian_microstructure',
          cadenceMinutes: 30,
          relevanceWeights: { topical: 0.25, freshness: 0.45, evidenceFit: 0.3 },
        },
        position: { x: 0, y: 560 },
      },
      {
    ...
    decisionNodes: DUAL_CURATOR_RESEARCH_SEEDS({
      curator0: 'microstructure_context',
      curator1: 'external_market_news',
      librarianSubtype: 'librarian_microstructure',
      libraryClass: 'specialty_evidence',
      pipeline0: ['discover', 'quote_quality', 'verify_sanity'],
      pipeline1: ['discover', 'regime_frame', 'verify_sanity'],
      emitMode: 'to_desk_stream',
    }),
  },
  ...
  // ── Simulation ENGINEs (D-189) — paper_sim / funds_only by default ─────────
  {
    ...
    modules: [
      ...
      {
        type: 'analyzer',
        name: 'Gate Analyzed Feed',
        config: {
          emitMode: 'to_desk_stream',
          streamDescriptor: 'gate_analyzed_settings',
          hubFeedClass: 'analyzed',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'semantic',
        },
        position: { x: 1380, y: 0 },
      },
      {
        type: 'analyzer',
        name: 'Gate Direct Feed',
        config: {
          emitMode: 'to_library',
          streamDescriptor: 'gate_direct_hub_feed',
          hubFeedClass: 'direct',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'system_normalized',
        },
        position: { x: 1380, y: 230 },
      },
      {
        type: 'policy',
    ...
    links: [
      ...
      { fromIndex: 2, toIndex: 6, linkKind: 'verification' },
  ...
  },
  {
    ...
    modules: [
      ...
      {
        type: 'analyzer',
        name: 'Training Analyzed Feed',
        config: {
          emitMode: 'to_desk_stream',
          streamDescriptor: 'training_analyzed_hub_feedback',
          hubFeedClass: 'analyzed',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'semantic',
        },
      ...
      {
        type: 'analyzer',
        name: 'Training Direct Feed',
        config: {
          emitMode: 'to_library',
          streamDescriptor: 'training_direct_hub_feed',
          hubFeedClass: 'direct',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'system_normalized',
        },
  ...
  },
  {
    ...
    modules: [
      ...
      {
        type: 'analyzer',
        name: 'Adhoc Analyzed Feed',
        config: {
          emitMode: 'to_desk_stream',
          streamDescriptor: 'adhoc_analyzed_feed',
          hubFeedClass: 'analyzed',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'semantic',
        },
      ...
      {
        type: 'analyzer',
        name: 'Adhoc Direct Feed',
        config: {
          emitMode: 'to_library',
          streamDescriptor: 'adhoc_direct_feed',
          hubFeedClass: 'direct',
          hubShelfOrigin: 'sim_training',
          hubShelfStream: 'system_normalized',
        },
    ...
    links: [
      ...
      { fromIndex: 3, toIndex: 7, linkKind: 'verification' },
