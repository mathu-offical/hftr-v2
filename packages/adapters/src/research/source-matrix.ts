...
const FEED_CLASS_ALIASES: Record<string, ResearchSourceKind> = {
  ...
  fred_series_search: 'fred_macro',
  frankfurter_reference_rates: 'frankfurter_fx',
  coingecko_markets_ranked: 'coingecko_crypto',
  alpha_vantage_news_sentiment: 'alpha_vantage_news',
  gdelt_event_feed: 'gdelt_news',
  world_bank_indicators: 'world_bank_indicator',
  twelve_data_timeseries: 'twelve_data',
  marketstack_eod: 'marketstack',
