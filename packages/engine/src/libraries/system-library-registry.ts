    ...
    placeholderSeeds: [
      {
        ...
        body: [
          ...
          '## Overnight',
          '',
          'Asia/Europe spillover and overnight news flow without price literals.',
          '',
          '## Wake-up',
          '',
          'Previous-night summary and overnight orientation.',
          '',
          '## Pre-market',
          '',
          'Morning news, other time zones, and market-condition context.',
          '',
          '## Open bell',
          '',
          'Open print, gap reaction, and first liquidity pulse.',
          '',
          '## Mid-morning',
          '',
          'Initial RTH movements and leadership tape.',
          '',
          '## Midday',
          '',
          'Progress check-in and strategy alignment themes.',
          '',
          '## Afternoon',
          '',
          'Pre-close exit strategies and pre-close analysis.',
          '',
          '## Power hour',
          '',
          'Final-hour liquidity and close positioning.',
          '',
          '## Market close',
          '',
          'Full day summary at/near the bell in qualitative bands.',
          '',
          '## Evening',
          '',
          'Additional news grounded in market-day movements. Link [[sector_rotation_signal]] when movers shelves are active.',
        ].join('\n'),
      },
    ],
